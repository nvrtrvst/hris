...
class UnitSekolah extends Model
{
    ...
    protected $fillable = ['nama', 'singkatan', 'logo', 'latitude', 'longitude', 'radius_meter', 'durasi_jp', 'max_jam_minggu', 'toleransi_menit', 'toleransi_slide_menit', 'jam_masuk_kantor', 'jam_pulang_kantor', 'jam_kerja_sabtu_mulai', 'jam_kerja_sabtu_selesai', 'web', 'telepon', 'alamat'];
