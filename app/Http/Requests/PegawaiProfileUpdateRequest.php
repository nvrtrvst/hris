...
class PegawaiProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pendidikan_tahun_lulus' => 'sometimes|nullable|integer|min:1950|max:2100',
            'pendidikan_asal_sekolah' => 'sometimes|nullable|string|max:255',
            'sk_nomor' => 'sometimes|nullable|string|max:100',
            'sk_tanggal' => 'sometimes|nullable|date',
