...
const FIELD_LABELS = {
    ...
    tmt_mengajar: 'Mulai Kerja',
    tanggal_akhir_kontrak: 'Akhir Kontrak',
    pendidikan_terakhir: 'Pendidikan',
    pendidikan_jurusan: 'Jurusan',
    pendidikan_tahun_lulus: 'Tahun Lulus',
    pendidikan_asal_sekolah: 'Asal Sekolah',
    nama_bank: 'Nama Bank',
            ...
            <div className="space-y-5 pb-8">
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <SectionCard title="Alamat & Kontak">
                        <Field name="alamat" label="Alamat KTP *" error={errors.alamat}>
                        ...
                        <Field name="no_hp_darurat" label="No. HP Darurat">
                    ...
                    <SectionCard title="Data Kepegawaian">
                        <Field name="status_kepegawaian" label="Status *" error={errors.status_kepegawaian}>
                            <ComboSelect value={data.status_kepegawaian} onChange={(v) => setData('status_kepegawaian', v)} options={statusKepegOptions} />
                        </Field>
                        <Field name="tmt_mengajar" label="Mulai Kerja *" error={errors.tmt_mengajar}>
                            <input type="date" value={data.tmt_mengajar} onChange={(e) => setData('tmt_mengajar', e.target.value)} className={inputClass} />
                        </Field>
                        <Field name="tanggal_akhir_kontrak" label="Akhir Kontrak" error={errors.tanggal_akhir_kontrak}>
                        ...
                        <Field name="pendidikan_terakhir" label="Pendidikan *" error={errors.pendidikan_terakhir}>
                            <ComboSelect value={data.pendidikan_terakhir} onChange={(v) => setData('pendidikan_terakhir', v)} options={pendidikanOptions} />
                        </Field>
                        <Field name="pendidikan_jurusan" label="Jurusan *" error={errors.pendidikan_jurusan}>
