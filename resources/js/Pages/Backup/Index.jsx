                        ...
                        <div className="flex items-start space-x-6">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-text-secondary mb-6 max-w-2xl">
                                    ...
                                    File hasil unduhan berformat <code className="bg-gray-50/80 px-2 py-1 rounded-input text-sm text-pink-600">.sql</code> yang dapat digunakan untuk proses *restore* atau migrasi server di masa depan.
                                </p>

                                {errors?.backup && (
                                    <div className="mb-6 p-4 bg-danger-light border-l-4 border-danger text-danger">
                                        <p className="font-bold">Gagal!</p>
                                        <p>{errors.backup}</p>
                                    </div>
                                )}

                                <div className="bg-surface p-6 rounded-card border border-secondary/20 inline-block">
