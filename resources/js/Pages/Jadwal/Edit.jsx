...
export default function Edit({ auth, jadwal, pegawais, units, kelas, mapel }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-2xl text-gray-800 leading-tight">Edit Jadwal Pegawai</h2>}
        >
