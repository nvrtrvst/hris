...
export default function Edit({ auth, jadwal, pegawais, units, mapel }) {
    const calcJp = (mulai, selesai, durasi) => {
        ...
        return Math.max(1, Math.round(selisih / durasi));
    };
    const [jumlahJp, setJumlahJp] = React.useState(() => calcJp(jadwal.jam_mulai, jadwal.jam_selesai, 45));
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        jenis_jadwal: jadwal.jenis_jadwal || 'mengajar',
        tahun_ajaran: jadwal.tahun_ajaran || '2026/2027',
        semester: String(jadwal.semester || '1'),
    });
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="page-title">Edit Jadwal Pegawai</h2>}
        >
